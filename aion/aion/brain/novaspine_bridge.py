...
def _runtime_context_summary(payload: dict | None) -> dict:
    ...
    return {
        ...
        "memory_feedback_status": str(rc.get("memory_feedback_status", "unknown")).strip().lower() or "unknown",
        "memory_feedback_risk_scale": _safe_float(rc.get("memory_feedback_risk_scale"), 1.0),
        "memory_feedback_turnover_pressure": _safe_float(rc.get("memory_feedback_turnover_pressure"), None),
        "memory_feedback_turnover_dampener": _safe_float(rc.get("memory_feedback_turnover_dampener"), None),
        "memory_feedback_block_new_entries": bool(rc.get("memory_feedback_block_new_entries", False)),
